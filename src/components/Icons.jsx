...
// 100% vetorial sem qualquer emoji ou imagem de terceiros
// ==============================================================================
...
// ==============================================================================
// ÍCONES DE OLHO (VER / OCULTAR SENHA)
// ==============================================================================
...
// ==============================================================================
// ÍCONES DO DESIGN SYSTEM APPLE (SEGURANÇA & KEYCHAIN)
// ==============================================================================
...
export const KeyIcon = AppleKeyIcon;
...
export const SparklesIcon = AppleSparklesIcon;
...
// ==============================================================================
// ÍCONES DO SISTEMA: SALVAR, AÇÃO, COPÍAR, CONTROLE DE SUPORTE
// ==============================================================================

// Salvar minimalista Apple (Substitui disquete feio)
...
// Stop / Cancelar Chamado
export const StopIcon = ({ className = "w-4 h-4" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
    <rect width="14" height="14" x="5" y="5" rx="2" ry="2" fill="currentColor" />
  </svg>
);
...
// Troféu Lúdico Apple (Para colaboradores com mais suportes resolvidos)
